...
fun MrbotoActivityBase.gestureClick(x: Int, y: Int): Boolean {
...
fun MrbotoActivityBase.gestureLongClick(x: Int, y: Int): Boolean {
    return dispatchGesture {
        val path = Path().apply { moveTo(x.toFloat(), y.toFloat()) }
        GestureDescription.Builder().addStroke(
...
fun MrbotoActivityBase.gestureSwipe(x1: Int, y1: Int, x2: Int, y2: Int, durationMs: Int = 300): Boolean {
    return dispatchGesture {
        val path = Path().apply {
...
fun MrbotoActivityBase.gestureScroll(x1: Int, y1: Int, x2: Int, y2: Int, durationMs: Int = 300): Boolean {
