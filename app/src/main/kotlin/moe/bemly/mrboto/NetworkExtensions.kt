...
fun MrbotoActivityBase.httpGetEx(url: CharSequence, headersJson: CharSequence? = null): String {
    return try {
...
fun MrbotoActivityBase.httpPostEx(url: CharSequence, body: CharSequence, headersJson: CharSequence? = null): String {
    return try {
        val conn = URL(url.toString()).openConnection() as HttpURLConnection
...
fun MrbotoActivityBase.httpUpload(url: CharSequence, filePath: CharSequence, fieldName: CharSequence = "file"): String {
    return try {
...
fun MrbotoActivityBase.httpStream(url: CharSequence, headersJson: CharSequence? = null): String {
