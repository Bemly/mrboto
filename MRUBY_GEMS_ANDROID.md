...
| mruby-hmac                  | HMAC 摘要                                      |
| mruby-hs-regexp             | 轻量正则 (Henry Spencer)                         | x |
| mruby-http                  | HTTP 解析器                                     |
...
| mruby-oauth                 | OAuth 类                                      |
| mruby-onig-regexp           | Onigmo 正则表达式 (C 实现)                          | x |
...
| mruby-pcre-regexp           | PCRE 正则表达式                                   | x |
